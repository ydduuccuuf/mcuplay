...
#define MF522_RST_CLK                    RCC_AHB1Periph_GPIOC
 
#define MF522_MISO_PIN                   GPIO_Pin_3
#define MF522_MISO_PORT                  GPIOA
#define MF522_MISO_CLK                   RCC_AHB1Periph_GPIOA
 
#define MF522_MOSI_PIN                   GPIO_Pin_6
#define MF522_MOSI_PORT                  GPIOA
#define MF522_MOSI_CLK                   RCC_AHB1Periph_GPIOA
 
#define MF522_SCK_PIN                    GPIO_Pin_11
#define MF522_SCK_PORT                   GPIOF
#define MF522_SCK_CLK                    RCC_AHB1Periph_GPIOF
 
#define MF522_NSS_PIN                    GPIO_Pin_12
#define MF522_NSS_PORT                   GPIOF
#define MF522_NSS_CLK                    RCC_AHB1Periph_GPIOF
